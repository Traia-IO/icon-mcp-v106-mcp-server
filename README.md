# ICON MCP v106 MCP Server

This is an MCP (Model Context Protocol) server that provides access to the ICON MCP v106 API. It enables AI agents and LLMs to interact with ICON MCP v106 through standardized tools.

## Features

- 🔧 **MCP Protocol**: Built on the Model Context Protocol for seamless AI integration
- 🌐 **Full API Access**: Provides tools for interacting with ICON MCP v106 endpoints
- 🐳 **Docker Support**: Easy deployment with Docker and Docker Compose
- ⚡ **Async Operations**: Built with FastMCP for efficient async handling

## API Documentation

- **ICON MCP v106 Website**: [https://api.apis.guru/v2/](https://api.apis.guru/v2/)
- **API Documentation**: []()
...
*Note: Replace `example_tool` with actual ICON MCP v106 API tools based on the documentation.*
...
1. Clone this repository:
   ```bash
   git clone https://github.com/Traia-IO/icon-mcp-v106-mcp-server.git
   cd icon-mcp-v106-mcp-server
   ```
...
1. Create API client functions for ICON MCP v106 endpoints
...
```json
{
  "github_url": "https://github.com/Traia-IO/icon-mcp-v106-mcp-server",
  "mcp_server": {
    "name": "icon-mcp-v106-mcp",
    "description": "V106 icon mcp",
